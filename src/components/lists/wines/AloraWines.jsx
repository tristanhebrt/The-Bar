...
const White = [
    {
        title: "Sauvignon Blanc - Crowded House, Marlborough, New Zealand",
        price: "$65",
    ...
    {
        title: "Pinot Grigio - Tiefenbrunner, Alto Adige-Trentino, Italy",
        price: "$70",
    ...
    {
        title: "Thirty Bench Riesling, Ontario, Canada",
        price: "$70",
    ...
    {
        title: "Chardonnay - Bella Terra, Ontario, Canada",
        price: "$75",
    ...
    {
        title: "Albariño - Paco and Lola, Salnes Valley, Spain",
        price: "$75",
    ...
    {
        title: "Sancerre - Daniel Chotard, Loire, France",
        price: "$97",
    ...
    {
        title: "Petit Chablis - La Manufacture, Burgundy, France",
        price: "$105",
    ...
    {
        title: "Rosé - Whispering Angel, Provence, France",
        price: "$90",
...
const Red = [
    {
        title: "Montepulciano d'Abruzzo - Masciarelli, Abruzzo, Italy",
        price: "$50",
    ...
    {
        title: "Cabernet Sauvignon - Thievery, California, USA",
        price: "$55",
    ...
    {
        title: "Pinot Noir - Centrestone, Oregon, USA",
        price: "$60",
    ...
    {
        title: "Shiraz - Domaine de L'Amandine 'Ségurets', Côtes du Rhône Villages, France",
        price: "$70",
    ...
    {
        title: "Zinfandel Blend - Conundrum, California, USA",
        price: "$72",
    ...
    {
        title: "Chianti Classico - Il Palei, Tuscany, Italy",
        price: "$75",
    ...
    {
        title: "Nebbiolo d'Alba - Deltetto, Piedmont, Italy",
        price: "$81",
    ...
    {
        title: "Shiraz - Two Hands 'Gnarly Dudes', Barossa Valley, Australia",
        price: "$83",
    ...
    {
        title: "Ripasso - Zenato, Veneto, Italy",
        price: "$88",
    ...
    {
        title: "Syrah/Carmenère - Emiliana Coyam Organic, Colchagua, Chile",
        price: "$90",
    ...
    {
        title: "Cabernet Sauvignon - Precision, Napa Valley, USA",
        price: "$120",
    ...
    {
        title: "Zinfandel Blend - The Prisoner, Napa Valley, USA",
        price: "$150",
    ...
    {
        title: "Brunello di Montalcino - Castello Banfi, Tuscany, Italy",
        price: "$150",
    ...
    {
        title: "Barolo - Arnaldo Rivera 'Undicicomuni', Piedmont, Italy",
        price: "$170",
    ...
    {
        title: "Cabernet Sauvignon - Austin Hope, Napa Valley, USA",
        price: "$210",
...
const Bubbles = [
    {
        title: "Prosecco - Serenissima, Veneto, Italy",
        price: "$60",
    ...
    {
        title: "Franciacorta Brut - Corte Aura, Lombardia, Italy",
        price: "$90",
    ...
    {
        title: "Crémant - Bailly Lapierre Reserve Brut, France",
        price: "$75",
    ...
    {
        title: "Champagne - Veuve Cliquot Brut, France",
        price: "$220",
    ...
    {
        title: "Champagne - Dom Perignon Brut, France",
        price: "$550",
...
const AloraWines = () => {
    return (
        <>
            <WineCardDisplay mainTitle="White Wines" recipes={White}></WineCardDisplay>
